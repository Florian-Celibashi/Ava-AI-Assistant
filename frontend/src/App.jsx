...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="flex flex-col flex-1 mx-auto bg-white shadow-2xl rounded-lg overflow-hidden max-w-2xl border border-gray-300">
        <div className="sticky top-0 z-10 flex items-center gap-4 p-4 bg-gray-100 border-b border-gray-300">
        ...
        <div className="sticky bottom-0 z-10 flex items-center gap-2 p-4 bg-white border-t border-gray-300">
          <input
            type="text"
